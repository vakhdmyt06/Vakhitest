...
winbuild:
	...
	i686-w64-mingw32-g++-win32 src/*.cpp -o win/out/Vakhitest.exe -I. -Lwin/lib -lsfml-window -lsfml-graphics -lsfml-system -std=c++20 -m32 -O2 -s -DNDEBUG -static-libgcc -static-libstdc++
